<template>
  <div class="emergency">
    ...
    <div class="box-body">
      <ul>
        <div class="swiper">
          <swiper ref="emSwiper" :options="swiperOption">
            <swiper-slide v-for="(item,index) of emergencyHookcCp.records" :key="index">
              <li>
                <div class="left">
                  <img src="../../assets/images/warn/emergency.png" alt="">
                  <div class="font"/>
                </div>
                <div class="right">
...
export default {
    ...
    computed: {
        swiper() {
            return this.$refs.emSwiper.swiper
        }
    },
    watch: {
        emergencyHookInfo(newValue, oldValue) {
            ...
            this.emergencyHookcCp = this.emergencyHookInfo
        }
    }
}
</script>
        ...
        ul {
            ...
            li {
                ...
                .left {
                    ...
                    position: relative;
                    //  background: url("../../assets/warn/warn_2.png") repeat;
                    // background-size: 100%;
                    ...
                    .font {
                        height: 1.83rem;
                        width: 1.83rem;
                        background: url("../../assets/images/warn/warn_font.png")
                            repeat;
                        background-size: 100% 100%; //会适应浏览器大小
                        position: absolute;
                        left: 0;
                        top: -0.2rem;
                        animation: radar-beam 0.3s infinite 0.9s ease-in-out
                            alternate;
                    }
                }
                div {
