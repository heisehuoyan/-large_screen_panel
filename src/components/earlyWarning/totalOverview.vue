                        ...
                        <div class="swiper-body">
                            ...
                            <div class="swipe-2">
                                <div style="position: relative;z-index: 1;">
                                    <span :style="filterA(item.content.length)" style="width: 15rem; white-space: nowrap;position: relative;">
    ...
    .swiper-slide {
        .swipe-1 {
           ...
           // position: relative;
            ...
            .first-level {
                background: url("../../assets/images/warn/first-level.png")
                    repeat;
                background-size: 100% 100%;
                background-position: center center;
            }
            .second-level {
                background: url("../../assets/images/warn/second-level.png")
                    repeat;
                background-size: 100% 100%;
                background-position: center center;
            }
            .thrid-level {
                background: url("../../assets/images/warn/third-level.png")
                    repeat;
                background-size: 100% 100%;
                background-position: center center;
            }
