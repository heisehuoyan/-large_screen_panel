    ...
    <div class="bubble_container">
      <transition-group name="bounce">
        <div
          ...
          class="bubble bubble_text"
        >
          <div style="top: 50%;transform: translateY(-50%);position: relative;line-height: 1rem;">
            <span>{{ bubble.count }}</span>
            <p
              style="position: static;height: 0.6rem;font-family: PingFangHK-Regular;font-size: 0.26rem;color: #FFFFFF;letter-spacing: -0.52px;text-align: center; margin-block-start: 0em;margin-block-end: 0em;line-height: 0rem;"
            >{{ bubble.name }}</p>
          </div>
        </div>
      </transition-group>
